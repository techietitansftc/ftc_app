...
@Autonomous(name = "Short_Center",group = "TechieTitans")
public class TTAuto_Short_Center extends TTTeleOp {
      ...
      //*********Start State Machine
        switch (currentState) {
            ...
            case 3:
                ...
                if (gyroPointTurn(.3, turnDirection, 30)) {
                    currentState++;
                }
                break;
