...
@Autonomous(name = "Red Auto",group = "TechieTitans")
@Disabled
public class TTAutoV3 extends TTTeleOp {
...
//            dcRun(back_right, 0);
        ...
        switch (currentState) {
            ...
            case 2:
                ...
                if (gyroPointTurn(TURN_POWER, Sides.LEFT, 32)) {
                    currentState++;
                    leftStartPosition = Math.abs(front_left.getCurrentPosition());
                    rightStartPosition = Math.abs(front_right.getCurrentPosition());
                }
...
//                //Empty state
            ...
            case 8:
                if (!IsPushed) {
                    if (getBeaconColor() == Colors.RED) {
                        //Push Right Button
                        pusher_right.setPosition(125.0 / 255.0);
                        pusher_left.setPosition(63.0 / 255.0);
                        IsPushed = true;
                    } else if (getBeaconColor() == Colors.BLUE) {
                        //Push Left Button
            ...
            case 10:
                ...
                if (gyroPointTurn(.3, Sides.RIGHT, 70)) {
                    IsPushed = false;
                    currentState++;
                    leftStartPosition = Math.abs(front_left.getCurrentPosition());
                    rightStartPosition = Math.abs(front_right.getCurrentPosition());
...
//                }
            ...
            case 14:
                //TODO: Blue>>Right , Red>>Left
                if (gyroPointTurn(TURN_POWER, Sides.LEFT, 78)) {
                    currentState++;
            ...
            case 18:
                //TODO: Blue>>Right , Red>>Left
                if (gyroPointTurn(.5, Sides.LEFT, 120)) {
